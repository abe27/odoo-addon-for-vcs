# -*- coding: utf-8 -*-
{
    ...
    'summary': 'จัดการข้อมูล VCS Master Data',# summary คือ คำอธิบายสั้นๆ ของโมดูล
    'description': 'ระบบจัดการข้อมูล Master Data พัฒนาขึ้มมาเพื่อบริษัทในเคลือของ VCS Group.',# description คือ คำอธิบายยาวของโมดูล
